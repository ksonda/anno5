...
## assemble bounding box to get OSM data from

# get from place name
# bbx <- getbb("Palo Alto, CA")

# didnt give exactly what I wanted, assemble custom bounding box
min_lon <- -122.2399
max_lon <- -122.0457
min_lat <- 37.3516
max_lat <- 37.4650
...
#get main road network from OSM
highways <- bbx %>%
  opq()%>%
...
# get secondary road netowrk from OSM
streets <- bbx %>%
  opq()%>%
  add_osm_feature(key = "highway", 
...
#get land boundaries, subtract out water
require(tigris)
